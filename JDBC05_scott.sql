...
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '사장', 4250000);  -- 425만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '전무', 3800000);  -- 380만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '상무', 3500000);  -- 350만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '이사', 3100000);  -- 310만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '부장', 2450000);  -- 245만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '차장', 2350000);  -- 235만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '과장', 2260000);  -- 226만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '대리', 1800000);  -- 180만원
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '사원', 1650000);  -- 165만원
--==>> 1 행 이(가) 삽입되었습니다. * 9
...
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '이름', '주민번호', TO_DATE(sysdate, 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '부산') , '전화번호' , (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원'), 4000000, 120000)
;
...
AS 
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, TO_CHAR(E.IBSADATE, 'YYYY-MM-DD') AS IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG
     , (E.BASICPAY + E.SUDANG) AS PAY
FROM TBL_EMP E JOIN TBL_CITY C
ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B
ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J
...
-- 검색 직원수 출력 쿼리문(사번/ 이름/ 부서 /직위)
SELECT COUNT(*) AS COUNT
FROM EMPVIEW
WHERE EMP_NAME = '김민성';
-- 한줄 구성
SELECT COUNT(*) AS COUNT FROM EMPVIEW WHERE EMP_NAME = '김민성'
;
desc tbl_emp;


-- 직원 정보 수정
UPDATE TBL_EMP SET EMP_NAME = '이름임', SSN = '970725-1123411', IBSADATE = TO_DATE('2022-03-24', 'YYYY-MM-DD'), CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '부산'), TEL = '010-1111-2222', BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부'), JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원'), BASICPAY = 2100000, SUDANG = 210000 WHERE EMP_ID = 1014
;
--==>> 1 행 이(가) 업데이트되었습니다.
